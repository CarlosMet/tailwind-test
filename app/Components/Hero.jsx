...
export default function Hero() {
  ...
  return (
    <div className='overflow-hidden w-[100vw] h-[100vh] relative py-[306px] lg:py-48 2xl:py-80 px-3 md:px-12 lg:px-16 xl:px-36 2xl:px-64'>
        ...
        <img ref={avatarRef} className='absolute top-14 w-6/12 right-1/2 translate-x-1/2 lg:translate-x-0 lg:top-auto lg:bottom-0 lg:right-20 xl:right-40 2xl:right-64 lg:w-[29%] z-20' src="https://i.imgur.com/OTdKfwe.png" alt="" />
